...
pub fn card_name(language: Language, card: CardId) -> &'static str {
    match language {
        Language::Chinese => match card {
            ...
            CardId::Breaker => "破甲打击",
            CardId::Execute => "处决",
            CardId::BattleTrance => "战斗专注",
            CardId::KingsSlash => "王者斩击",
            CardId::BloodPact => "血契",
        },
        Language::English => match card {
            ...
            CardId::IronWall => "Iron Wall",
            CardId::Breaker => "Breaker",
            CardId::Execute => "Execute",
            CardId::BattleTrance => "Battle Trance",
            CardId::KingsSlash => "King's Slash",
            CardId::BloodPact => "Blood Pact",
        },
    }
}
...
pub fn card_text(language: Language, card: CardId) -> &'static str {
    match language {
        Language::Chinese => match card {
            ...
            CardId::Cleave => "造成 8 + 攻击 点伤害。",
            CardId::IronWall => "获得 10 + 2x防御 点格挡。",
            CardId::Breaker => "造成 6 + 攻击 点伤害。\n清除敌人格挡。",
            CardId::Execute => "造成 12 + 2x攻击 点伤害。\n敌人半血以下翻倍。",
            CardId::BattleTrance => "抽 2 张牌，获得 1 点能量。",
            CardId::KingsSlash => "造成 22 + 3x攻击 点伤害。\n获得防御值格挡。",
            CardId::BloodPact => "失去 6 点生命。\n抽 2 张牌，获得 1 点能量。",
        },
        Language::English => match card {
            ...
            CardId::Cleave => "Deal 8 + Attack damage.",
            CardId::IronWall => "Gain 10 + 2x Defense block.",
            CardId::Breaker => "Deal 6 + Attack damage. Clear enemy block.",
            CardId::Execute => "Deal 12 + 2x Attack damage. Double below half HP.",
            CardId::BattleTrance => "Draw 2 cards and gain 1 Energy.",
            CardId::KingsSlash => "Deal 22 + 3x Attack damage. Gain Defense block.",
            CardId::BloodPact => "Lose 6 HP. Draw 2 cards and gain 1 Energy.",
        },
    }
}
...
pub fn log_card(language: Language, card: CardId, damage: i32) -> String {
    match language {
        Language::Chinese => match card {
            ...
            CardId::Cleave => format!("横扫造成 {damage} 点伤害。"),
            CardId::IronWall => format!("铁壁获得 {damage} 点格挡。"),
            CardId::Breaker => format!("破甲打击清除格挡并造成 {damage} 点伤害。"),
            CardId::Execute => format!("处决造成 {damage} 点伤害。"),
            CardId::BattleTrance => "战斗专注抽 2 张牌，并获得 1 点能量。".to_string(),
            CardId::KingsSlash => format!("王者斩击造成 {damage} 点伤害。"),
            CardId::BloodPact => "血契失去生命，抽 2 张牌，并获得 1 点能量。".to_string(),
        },
        Language::English => match card {
            ...
            CardId::Cleave => format!("Cleave deals {damage}."),
            CardId::IronWall => format!("Iron Wall adds {damage} block."),
            CardId::Breaker => format!("Breaker clears block and deals {damage}."),
            CardId::Execute => format!("Execute deals {damage}."),
            CardId::BattleTrance => "Battle Trance draws 2 and gains 1 Energy.".to_string(),
            CardId::KingsSlash => format!("King's Slash deals {damage}."),
            CardId::BloodPact => "Blood Pact costs HP, draws 2, and gains 1 Energy.".to_string(),
        },
    }
}
